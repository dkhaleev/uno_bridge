...
SDRunoPlugin_RemoteBridgeForm::SDRunoPlugin_RemoteBridgeForm(SDRunoPlugin_RemoteBridgeUi& parent, IUnoPluginController& controller) :
...
void SDRunoPlugin_RemoteBridgeForm::Setup()
{
	...
	hModule = GetModuleHandle(L"SDRunoPlugin_RemoteBridge");
	hdc = GetDC(NULL);
